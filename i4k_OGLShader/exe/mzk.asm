; Listing generated by Microsoft (R) Optimizing Compiler Version 19.10.25019.0 
	...
	TITLE	C:\Users\polyr\Development\cpp\4k\i4k_OGLShader\src\mzk.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\polyr\development\cpp\4k\i4k_oglshader\src\system.h
;	COMDAT ?f2i@@YGHM@Z
_TEXT	SEGMENT
_tmp$ = -4						; size = 4
_x$ = 8							; size = 4
...
_TEXT	ENDS
; Function compile flags: /Ogspy
; File c:\users\polyr\development\cpp\4k\i4k_oglshader\src\mzk.cpp
...
; 13   :     for( int i=0; i<MZK_NUMSAMPLES; i++ ) 
...
; 14   :     {
; 15   :         const float fl = sinf( 6.2831f*440.0f * (float)i/(float)MZK_RATE );
...
; 16   :         const float fr = sinf( 6.2831f*587.3f * (float)i/(float)MZK_RATE );
; 17   : 
